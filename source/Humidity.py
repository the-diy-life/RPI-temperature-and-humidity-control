...
# Form implementation generated from reading ui file 'Humidity.ui'
#
...
from plotter_humidity import CustomWidget
...
"font-weight:bold;")
        ...
        self.lblHumidity = QtWidgets.QLabel(Temperature)
        font = QtGui.QFont()
        ...
        self.gridLayout.addWidget(self.lblHumidity, 0, 0, 1, 2)
    ...
    def retranslateUi(self, Temperature):
        ...
        self.lblCurrentReading.setText(_translate("Temperature", "Humidity: 14%"))
...
"Control"))
        self.btnTemperature.setText(_translate("Temperature", "Temperature"))
        self.lblTime.setText(_translate("Temperature", "10-10-2019 17:06:21"))
        self.lblHumidity.setText(_translate("Temperature", "Humidity State"))
...
###########################################################################
    ...
    def update_read(self):
            ...
            temp= "current humidity: {0:0.1f}%".format(globals.humidity_read)
            #print(temp)
