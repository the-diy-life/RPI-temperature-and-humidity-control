...
class  CustomWidget(pg.GraphicsWindow):
    ...
    def __init__(self, parent=None, **kargs):
        ...
        self.list_y2=[]
        self.xli=[]
        self.list_y2=globals.humidity_list_value
        self.xli=globals.humidity_list_date
        

        self.p1 = self.addPlot(labels =  {'left':'humidity', 'bottom':'Time'},axisItems = {'bottom': date_axis})
        last=len(self.xli)-1
        if last >=0:
            self.f=self.xli[last]
            self.p1.setXRange(self.f-100, self.f+60)
